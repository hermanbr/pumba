...
// validateLoss checks netem loss parameters; shared by the loss and combo commands.
...
// lossArgs builds the netem 'loss ...' argument list; shared by the loss and combo commands.
